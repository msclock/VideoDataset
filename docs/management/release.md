...
1. Build and publish the Development and Production Containers with the build cache to GitHub Packages.
    1. The Production Container is tagged as `ghcr.io/ai-platform/fast-context-queue:py<PYTHON_VERSION>` for the latest version and `ghcr.io/ai-platform/fast-context-queue:py<PYTHON_VERSION>-<PROJECT_VERSION>` for archives.
    1. The Development Container is tagged as `ghcr.io/ai-platform/fast-context-queue/dev:py<PYTHON_VERSION>` for the latest version and `ghcr.io/ai-platform/fast-context-queue/dev:py<PYTHON_VERSION>-<PROJECT_VERSION>` for archives.
    1. The build cache for the Development Container is tagged as `ghcr.io/ai-platform/fast-context-queue/dev-cache:py<PYTHON_VERSION>`.
...
1. Build and publish the Development and Production Containers with build cache to GitLab Container Registry.
    1. The Production Container is tagged as `registry.gitlab.com/ai-platform/fast-context-queue:py<PYTHON_VERSION>` for the latest version and `registry.gitlab.com/ai-platform/fast-context-queue:py<PYTHON_VERSION>-<PROJECT_VERSION>` for archives.
    1. The Development Container is tagged as `registry.gitlab.com/ai-platform/fast-context-queue/dev:py<PYTHON_VERSION>` for the latest version and `registry.gitlab.com/ai-platform/fast-context-queue/dev:py<PYTHON_VERSION>-<PROJECT_VERSION>` for archives.
    1. The build cache for the Development Container is tagged as `registry.gitlab.com/ai-platform/fast-context-queue/dev-cache:py<PYTHON_VERSION>`.
