...
Fork the repository to your own namespace, and let us take `https://code.agibot.com/<username>/fast-context-queue` as example.

Clone the repository and navigate to the root directory:

```shell
git clone git@code.agibot.com:<username>/fast-context-queue.git
cd fast-context-queue
```
...
```shell
git remote add upstream https://code.agibot.com/ai-platform/fast-context-queue
git fetch upstream
```
...
```shell
git remote set-url --push upstream git@code.agibot.com/<username>/fast-context-queue.git
```
...
```shell
origin  git@code.agibot.com:<username>/fast-context-queue.git (fetch)
origin  git@code.agibot.com:<username>/fast-context-queue.git (push)
upstream        https://code.agibot.com/ai-platform/fast-context-queue (fetch)
upstream        git@code.agibot.com:<username>/fast-context-queue.git (push)
```
